  ...
  return (
    <main className='grid grid-cols-2 min-h-screen'>
      ...
      <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
        {/* Blur */}
        <div className="absolute right-0 top-1/2 h-[288px] w-[529px] -translate-y-1/2 translate-x-1/2 bg-purple-700 opacity-50 rounded-full blur-full"></div>
        {/* Stripes */}
        ...
        {/* Copyright */}
        <div className='text-sm leading-relaxed text-gray-200'>Feito com 💜 no NLW da <a target='_blank' rel='noreferrer' className='underline hover:text-gray-100' href='https://rocketseat.com.br'>Rocketseat</a></div>
